...
func HasLastAccessedBy() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasLastAccessedByWith(preds ...predicate.User) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func HasOrganizationMemberships() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasOrganizationMembershipsWith(preds ...predicate.OrganizationMember) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
