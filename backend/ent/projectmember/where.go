...
func PermissionEQ(v Permission) predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldEQ(FieldPermission, v))
}

// PermissionNEQ applies the NEQ predicate on the "permission" field.
func PermissionNEQ(v Permission) predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldNEQ(FieldPermission, v))
}

// PermissionIn applies the In predicate on the "permission" field.
func PermissionIn(vs ...Permission) predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldIn(FieldPermission, vs...))
}

// PermissionNotIn applies the NotIn predicate on the "permission" field.
func PermissionNotIn(vs ...Permission) predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldNotIn(FieldPermission, vs...))
}
